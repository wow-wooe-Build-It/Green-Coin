...
object MissionRepository {
    ...
    suspend fun uploadMissionProof(userId: String, imageBytes: ByteArray): String = withContext(Dispatchers.IO) {
    ...
    suspend fun submitMission(userId: String, missionId: String, imageUrl: String?, description: String?) = withContext(Dispatchers.IO) {
